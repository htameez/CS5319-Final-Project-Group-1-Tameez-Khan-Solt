...
const intakeFields = [
  'Name plus profile context used by the layered frontend bundle',
  'Health goals stored in the selected backend profile flow',
  'Medications saved and reused in later responses',
]

const capabilities = [
  'Provide a dedicated UI for the selected layered architecture',
  'Create or update profile context before generating wellness guidance',
  'Store chat history and saved favorites in the selected layered backend',
...
const behaviorFlow = [
  'User opens the selected architecture bundle',
  'The layered frontend sends profile fields and the question to the selected backend',
...
function App() {
  const activeMeta = architectureMeta.layered
    ...
    <main className="page-shell">
      <section className="hero-panel">
        <div>
          ...
          <p className="hero-text">
            This bundle contains the selected layered architecture for the AI
            healthcare chatbot. The frontend and backend are grouped together so
            the selected option can be run and demonstrated as one complete
            architectural package.
          </p>
          <div className="tag-row">
            <span>Dedicated React UI</span>
            <span>Layered frontend + backend</span>
        ...
        <div className="hero-side">
          ...
          <div className="summary-card">
            ...
            <strong>Selected architecture bundle</strong>
          </div>
          <div className="summary-card">
      ...
      <section className="panel">
        <div className="section-heading">
          ...
          <h2>How this selected bundle works</h2>
        </div>
        <div className="grid-two">
          <article className="info-card">
